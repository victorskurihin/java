...
class BookTest
{
    ...
    class WhenNewAllArgsConstructor
    {
        ...
        void createNew()
        {
            book = new Book(TEST_ID, TEST_ISBN, TEST_TITLE, TEST_NUM, TEST_COPYRIGHT, publisher, null, genre, null);
        }
        ...
        void testEquals()
        {
            ...
            Book expected = new Book(TEST_ID, TEST_ISBN, TEST_TITLE, TEST_NUM, TEST_COPYRIGHT, publisher, null, genre, null);
