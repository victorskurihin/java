...
class ReviewTest
{
    ...
    class WhenNewAllArgsConstructor
    {
        ...
        void createNew()
        {
            review = new Review(TEST_ID, TEST_COMMENT_NAME);
        }
        ...
        void defaults()
        {
            assertThat(review).hasFieldOrPropertyWithValue("id", TEST_ID);
        ...
        void testEquals()
        {
            ...
            Review expected = new Review(TEST_ID, TEST_COMMENT_NAME);
