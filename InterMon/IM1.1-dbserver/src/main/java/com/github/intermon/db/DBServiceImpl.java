...
import com.github.intermon.cache.*;
import com.github.intermon.dao.*;
...
public class DBServiceImpl implements DBService {
    ...
    private static final Logger LOG = LogManager.getLogger(DBServiceImpl.class);
    ...
    public static Configuration defaultConfiguration() {
        ...
        cfg.setProperty("hibernate.connection.url", "jdbc:postgresql://localhost:5432/intermon");
