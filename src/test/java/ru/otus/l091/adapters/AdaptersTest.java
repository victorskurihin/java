...
import ru.otus.l091.dataset.TestClass;
...
public class AdaptersTest {
    ...
    public static final String CREATE_TABLE_EXPECTED2 = "CREATE TABLE IF NOT EXISTS " +
        "ru_otus_l091_dataset_TestDataSetClass" + CREATE_EXPECTED_CLAUSE;
    public static final String CREATE_TABLE_EXPECTED3 = "CREATE TABLE IF NOT EXISTS " +
        "ru_otus_l091_dataset_TestComplexDataSetClass ( id BIGSERIAL PRIMARY KEY, \"fk test\" BIGINT )";
    ...
    public static final String INSERT1_VALUES1 = "INSERT INTO ru_otus_l091_dataset_TestDataSetClass VALUES " +
        "(" + VALUES1 + " )";
    public static final String INSERT2_VALUES2 = "INSERT INTO ru_otus_l091_dataset_TestComplexDataSetClass " +
        "VALUES (14, 13 )";
    public static final String INSERT3_VALUES3 = "INSERT INTO relationship VALUES " +
        "('ru_otus_l091_dataset_TestComplexDataSetClass', 14, 'test', " +
        "'ru_otus_l091_dataset_TestDataSetClass', 13)";
